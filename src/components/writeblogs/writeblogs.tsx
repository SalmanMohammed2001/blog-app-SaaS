...
interface WriteblogsProps {
  setImages: (files: FileList) => void;
  FormDataDetails: (formData: FormDataType) => void;
  Contentdetsils: (content: string | undefined) => void;
}
...
const Writeblogs: React.FC<WriteblogsProps> = ({
  setImages,
  FormDataDetails,
  Contentdetsils,
}) => {

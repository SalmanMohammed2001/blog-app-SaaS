...
import { saveBlog, uploadImage } from "@/lib/supabase/blog";
...
const [loading, setLoading] = useState(true);
  ...
  return (
    ...
    {show ==true &&   <div className='w-full min-h-screen pb-10 text-black'>
...
FormDataDetails={handleFormDataDetails}
Contentdetsils={handleContentDetails}
/> */}
